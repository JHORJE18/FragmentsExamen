...
public class AficionesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rdBtnLibro = (RadioButton) v.findViewById(R.id.rdBtnLibros);
        rdBtnRevistas = (RadioButton) v.findViewById(R.id.rdBtnRevistas);
        rdBtnRedes = (RadioButton) v.findViewById(R.id.rdBtnRedes);
        starPuntuacion = (RatingBar) v.findViewById(R.id.ratingPuntuacion);
        btnGuardar = (Button) v.findViewById(R.id.btnGuardaAficiones);
