...
public class DatosPersonalesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txtNombreApedillos = (EditText) v.findViewById(R.id.editNombreApedillos);
        txtEdad = (EditText) v.findViewById(R.id.editEdad);
        rdBtnMasculino = (RadioButton) v.findViewById(R.id.rdBtnMasculino);
        rdBtnFemenino = (RadioButton) v.findViewById(R.id.rdBtnFemenino);
        btnGuardar = (Button) v.findViewById(R.id.btnGuardarDatosPersonales);
        ...
        btnGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (comprobarDatos()) {
                    ...
                    String nameApedillos = txtNombreApedillos.getText().toString();
                    String edad = txtEdad.getText().toString();
                    String sexo = sexoCheck();

                    c.recibirDatosPersonales(nameApedillos, edad, sexo);
    ...
    private boolean comprobarDatos(){
        if (txtNombreApedillos.getTextSize() < 0){
            return false;
        }
